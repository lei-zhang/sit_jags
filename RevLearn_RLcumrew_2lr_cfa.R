...
#       v[s,t,3-choice1[s,t]]  <- (sum_against >sum_with) * (vtmp[s,t,3-choice1[s,t]] + crw[s] * sum(cumrew_against[s,t,])) +
#                                 (sum_against<=sum_with) * (vtmp[s,t,3-choice1[s,t]] - crw[s] * sum(cumrew_against[s,t,]))
#       v[s,t,choice1[s,t]]    <- (sum_with>=sum_against) * (vtmp[s,t,choice1[s,t]] + cra[s]   * sum(cumrew_with[s,t,])) + 
#                                 (sum_with< sum_against) * (vtmp[s,t,choice1[s,t]] - cra[s]   * sum(cumrew_with[s,t,]))
      ...
      vtmp[s,t+1,3-choice2[s,t]] <- v[s,t,3-choice2[s,t]] + lr[s,2] * penc[s,t]
      vtmp[s,t+1,  choice2[s,t]] <- v[s,t,  choice2[s,t]] + lr[s,1] * pe[s,t]
